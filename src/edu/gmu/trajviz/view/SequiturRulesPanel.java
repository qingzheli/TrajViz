...
columnModel.getColumn(SequiturTableColumns.RULE_NUMBER.ordinal()).setPreferredWidth(30);
columnModel.getColumn(SequiturTableColumns.RULE_USE_FREQUENCY.ordinal()).setPreferredWidth(30);
/*
