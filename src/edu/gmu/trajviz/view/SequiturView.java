	...
	*/
	private void configureGUI() {
	 ...
	 // set the main panel layout
	    ...
	    frame.getContentPane().add(mapPanel,"w 45%,split");
	    frame.getContentPane().add(tabbedRulesPane, "w 10%, split");
	    frame.getContentPane().add(mapPanel1, "w 45%,wrap");
	...
	/**
	  ...
	  private void buildLogPane() {
		  // logging panel
		    ...
		    log(Level.INFO, "require data file format: x, y, status, time in UNIX epoch format");
	}
	  /**
	   * Logs message.
	   * 
